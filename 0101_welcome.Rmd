...
To install `epmr` package directly from github, you need `devtools` *and* a working development environment (a.k.a. an R friendly compiler). The specific compiler will depend on your operating system. 
