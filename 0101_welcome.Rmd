...
* epmr, [package webpage](https://github.com/talbano/epmr)

### Installing epmr

If you have trouble installing the epmr package, you are not alone. I, Prof. Mason, am working on resolving the issue. First, try this code. 

```{r, eval=FALSE}
if (!require("devtools")) install.packages("devtools")	 # Will install devtools if not already installed 
devtools::install_github("talbano/epmr")

```

It will install devtools, if you don't have it already and then compile the current version of the package for you.

If that doesn't work, I've compiled a version that *should* work. First download [this] file, and place it in your working directory.
...
```{r, echo=FALSE}
embed_url("https://www.youtube.com/watch?v=lo67SSJRScw") %>%
  use_align("center")
```
