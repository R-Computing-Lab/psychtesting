...
```{r item-cor, fig.show='hold', out.width='50%', fig.cap="Scatter plots showing the relationship between total scores on the x-axis with dichotomous item response on two PISA items on the y-axis."}
